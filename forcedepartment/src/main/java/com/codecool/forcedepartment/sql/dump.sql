...
INSERT INTO public.website_user VALUES (1, 'Oakley', 'Burns', 24, '+36305121220', false, 'user');
INSERT INTO public.website_user VALUES (2, 'Chase', 'Price', 45, '+36302548320', false, 'worker');
INSERT INTO public.website_user VALUES (3, 'Harris', 'Reynolds', 51, '+36305799390', false, 'worker');
INSERT INTO public.website_user VALUES (4, 'Spencer', 'Hayes', 41, '+36205739220', false, 'worker');
INSERT INTO public.website_user VALUES (5, 'Teddy', 'Hill', 34, '+36301154960', false, 'user');
INSERT INTO public.website_user VALUES (6, 'Lukas', 'Phillips', 39, '+36705792850', false, 'worker');
INSERT INTO public.website_user VALUES (7, 'Maximus', 'Morris', 55, '+36709482320', false, 'worker');
INSERT INTO public.website_user VALUES (8, 'Franklin', 'Chambers', 63, '+36305733321', false, 'worker');
INSERT INTO public.website_user VALUES (9, 'Lennox', 'Cole', 59, '+367047214393', false, 'user');
INSERT INTO public.website_user VALUES (10, 'Elis', 'Cooper', 38, '+36206658720', false, 'user');
INSERT INTO public.website_user VALUES (11, 'Tobias', 'Ball', 37, '+36305253371', false, 'worker');
INSERT INTO public.website_user VALUES (12, 'Jacob', 'Mccarthy', 40, '+36305724520', false, 'worker');
INSERT INTO public.website_user VALUES (13, 'Paul', 'Rodgers', 53, '+3630214556', false, 'worker');

INSERT INTO public.worker VALUES (1, 2, false, 7.4, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.');
INSERT INTO public.worker VALUES (2, 3, false, 5.2, 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.');
INSERT INTO public.worker VALUES (3, 4, false, 8.9, 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.');
INSERT INTO public.worker VALUES (4, 6, false, 7.1, 'Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam.');
INSERT INTO public.worker VALUES (5, 7, false, 7.8, 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.');
