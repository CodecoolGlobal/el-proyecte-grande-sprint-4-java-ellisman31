...
(
    ...
    birth_date          date NOT NULL, -- new entity
    email           varchar(150), -- new entity
    is_admin      boolean,
    password varchar(300), -- new entity
    registration_date date NOT NULL, -- new entity
    group_name     text
    -- ,image text
);
...
(
    ...
    phone_number varchar(200), -- CHANGE
